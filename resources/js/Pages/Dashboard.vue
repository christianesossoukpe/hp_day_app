...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-1">
            ...
            <div
                class="max-w-7xl mx-auto bg-white rounded-lg shadow-md p-6 overflow-hidden"
            >
                <h1
                    class="text-3xl font-bold mb-4 text-center animate-slide-left"
                ...
                <div class="mb-6">
                    <div class="flex items-center">
                        ...
                        <div
                            id="lottie-animation"
                            class="w-16 h-16 text-2xl font-semibold mb-2"
                        ></div>

                        <!-- Titre -->
                        <h2
                            class="text-2xl font-semibold mb-2"
                            style="font-family: 'LoversQuarrel', sans-serif"
                        >
                            Anniversaires du jour
                        </h2>
                        <!-- Conteneur pour l'animation Lottie -->
                    ...
                    <div class="flex gap-4 justify">
                        <div
                            v-for="friend in upcomingBirthdays"
                            :key="friend.id"
                ...
                <div class="text-center mt-8 relative overflow-hidden">
                    <h2
                        class="text-xl font-semibold animate-slide"
                        style="font-family: 'Charme', sans-serif"
                    >
