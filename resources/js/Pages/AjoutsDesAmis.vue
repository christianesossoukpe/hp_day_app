                ...
                <button  data-drawer-target="separator-sidebar" data-drawer-toggle="separator-sidebar"
                    ...
                    <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20"
                        ...
                        <path clip-rule="evenodd" fill-rule="evenodd"
                            d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.7
                            5 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z">
                        </path>
                    </svg>
                </button>
                        ...
                        <ul class="space-y-2 font-medium">
                            ...
                            <li>
                                <a href="#"
                                    ...
                                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                        ...
                                        viewBox="0 0 18 18">
                                        <path
                                            d="M6.143 0H1.857A1.857 1.857 0 0 0 0 1.857v4.286C0 7.169.831 8 1.857 8h4.286A1.857 1.857 0 0 0 
                                            8 6.143V1.857A1.857 1.857 0 0 0 6.143 0Zm10 0h-4.286A1.857 1.857 0 0 0 10 1.857v4.286C10 7.169 10.831 8 11.857
                                             8h4.286A1.857 1.857 0 0 0 18 6.143V1.857A1.857 1.857 0 0 0 16.143 0Zm-10 10H1.857A1.857 1.857 0 0 0 0 
                                             11.857v4.286C0 17.169.831 18 1.857 18h4.286A1.857 1.857 0 0 0 8 16.143v-4.286A1.857 1.857 0 0 0 6.143 
                                             10Zm10 0h-4.286A1.857 1.857 0 0 0 10 11.857v4.286c0 1.026.831 1.857 1.857 1.857h4.286A1.857 1.857 0 
                            ...
                            <li>
                                <a href="#"
                                    ...
                                    <span class="flex-1 ms-3 whitespace-nowrap">Voir vos voeux</span>
                                    <span
                            ...
                            <li>
                                <a href="/send"
                                    ...
                                    <span class="flex-1 ms-3 whitespace-nowrap">Ajouter des amis</span>
                                </a>
                            </li>
                            <li>
                                <a href="#"
                                    ...
                                    <span class="flex-1 ms-3 whitespace-nowrap">Amis suggerer</span>
                                </a>
                            </li>
                        ...
                        <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                            ...
                            <li>
                                <a href="#"
                                    ...
                                    <span class="ms-3">Paramètre</span>
                                </a>
                            </li>
                            <li>
                                <a href="#"
